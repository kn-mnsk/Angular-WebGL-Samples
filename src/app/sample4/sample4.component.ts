...
export class Sample4Component extends WebGLBaseWithoutTexture {
  ...
  override initialize(): void {
    ...
    this.shader.loadProgram(this.gl, './app/shaders/sample4.vs', './app/shaders/sample4.fs');
  ...
  override render(): void {
    ...
    mat4.translate(initModel, initModel, [0.0, 0.0, -7]);
